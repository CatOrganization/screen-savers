...
type PermeableSoftBodyBall struct {
...
func NewPermeableSoftBodyBall(world *box2d.B2World, center box2d.B2Vec2, radius float64, components int) *PermeableSoftBodyBall {
	ballRadius := radius / 8
	ball := &PermeableSoftBodyBall{color: rl.Red}
...
func (s *PermeableSoftBodyBall) Draw(dt float32, body *box2d.B2Body, fixture *box2d.B2Fixture) {
